...
<% } %>
                ...
                <!-- 댓글 작성 -->
                <form action="freecomment.jsp?num=<%=dto.getnum()%>">
                    <input type="hidden" name="num" value="<%=dto.getnum()%>">
   ...
   <hr>
    ...
    function deletePost() {
        ...
        if (confirmation) {
            window.location.href = "freeDelete.jsp?num=<%=dto.getnum()%>";
        }
    }
    ...
    function updatePost() {
        ...
        if (confirmation) {
            window.location.href = "freeUpdate.jsp?num=<%=dto.getnum()%>";
        }
    }
    ...
    function editComment(commentId) {
        ...
        if (confirmation) {
            window.location.href = "freecommentUpdate.jsp?name=<%=name%>&comment_id=" + commentId;
        }
    }
    ...
    function deleteComment(commentId) {
        ...
        if (confirmation) {
            window.location.href = "freecommentDelete.jsp?name=<%=name%>&comment_id=" + commentId;
        }
    }

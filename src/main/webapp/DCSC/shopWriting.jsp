...
<body>
	...
	<form action="shopWritingPro.jsp" method="post" enctype="multipart/form-data" class="validation-form" novalidate >
		    <div class="mb-3">
		        <label for="exampleFormControlInput1" class="form-label">제목</label>
		        <input class="form-control" id="exampleFormControlInput1" name="title" placeholder="제목을 입력하세요" required >
		    </div>
		    <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">가격</label>
              	<input class="form-control" id="exampleFormControlInput1" name="pay" placeholder="가격을 입력하세요" required >
            </div>
		    <div>
...
<%--     <div class="container">
        <div class="container mx-3 p-5 ">
            ...
            <p class="text-muted m-lg-1">
                 <b><%=NAME%></b>님 중고 거래를 통해 당신의 행복을 나누세요.
            </p>
        </div>
    	<form action="shopWritingPro.jsp" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">제목</label>
                <input name="title" type="text" class="form-control" id="exampleFormControlInput1" placeholder="제목을 입력하세요.">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">가격</label>
                <input name="pay" type="text" class="form-control" id="exampleFormControlInput1" placeholder="가격을 입력하세요.">
            </div>
            <div>
